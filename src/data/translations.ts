...
export const translations: Translation = {
  en: {
    ...
    about_p1: "Hello! I'm Mohammad Fahrezi, a passionate Computer Science student at Sriwijaya University with a deep fascination for Front-End Development and Graphic Design. I believe technology has the extraordinary power to transform creative ideas into meaningful digital experiences that make a real difference.",
