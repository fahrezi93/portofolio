...
export const translations: Translation = {
  en: {
    ...
    about_p1: "Hello! I'm Mohammad Fahrezi, a passionate Computer Science fresh graduate from Sriwijaya University with a deep fascination for Front-End Development and Graphic Design. I believe technology has the extraordinary power to transform creative ideas into meaningful digital experiences that make a real difference.",
    ...
    portfolio_tab_design_desc: "Graphic & Visual Design",
  ...
  id: {
    ...
    hero_rotating_4: "video",
    hero_tagline: "Saya berspesialisasi dalam membuat aplikasi web modern, intuitif, dan indah yang disukai pengguna.",
    ...
    about_p1: "Halo! Saya Mohammad Fahrezi, lulusan Ilmu Komputer dari Universitas Sriwijaya yang memiliki passion mendalam terhadap Front-End Development dan Graphic Design. Saya percaya teknologi memiliki kekuatan luar biasa untuk mengubah ide-ide kreatif menjadi pengalaman digital yang bermakna dan memberikan dampak nyata.",
    ...
    portfolio_tab_design_desc: "Graphic & Desain Visual",
    portfolio_tab_editing: "Video Editing",
